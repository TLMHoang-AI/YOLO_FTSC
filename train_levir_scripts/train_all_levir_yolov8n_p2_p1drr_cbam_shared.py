#!/usr/bin/env python3
"""Train seed-42 LEVIR P2-only P1-DRR with shared CBAM."""
...
_SPEC = importlib.util.spec_from_file_location("_p1drr_cbam_workflow", ROOT / "train_all_levir_yolov8n_p2_routing.py")
workflow = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = workflow
_SPEC.loader.exec_module(workflow)
workflow.EXPERIMENT = "levir_yolov8n_p2_p1drr_cbam_shared"
workflow.HF_REPO = "duyle2408/levir-yolov8n-p2-p1drr-cbam-shared-seed42"
workflow.VARIANTS = {
    "p1drr_cbam_shared": ROOT.parent
    / "models_related/models_config/yolov8/levir/yolov8n_p2_fpn_only_p1drr_cbam_shared.yaml"
}
