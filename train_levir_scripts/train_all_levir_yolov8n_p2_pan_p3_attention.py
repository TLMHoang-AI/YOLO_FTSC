#!/usr/bin/env python3
"""Train, evaluate, and upload the YOLOv8n LEVIR PAN-to-P3 Attention experiments."""
...
EXPERIMENT_SLUG = "levir_yolov8n_p2_pan_p3_attention"

# Set experiment name and destination repo
workflow.EXPERIMENT = EXPERIMENT_SLUG
workflow.HF_REPO = "duyle2408/levir-yolov8n-p2-pan-p3-attention-3seed"

# Set variant configuration mapping
workflow.VARIANTS = {
    "pan_p3_kvca": ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_levir_pan_p3_kvca.yaml",
    "pan_p3_cbam": ROOT.parent / "models_related/models_config/yolov8/levir/yolov8n_p2_levir_pan_p3_cbam.yaml"
}
