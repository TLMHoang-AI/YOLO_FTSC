...
pid_file = "/marimo/runs/levir_yolov8n_p2_topdown_seed42/resume_to_500.pid"
...
local_dir = "/marimo/runs/levir_yolov8n_p2_topdown_seed42/topdown_p1ger_500/seed_42"
...
if os.path.exists(local_dir):
    ...
    try:
        api.upload_folder(
            ...
            path_in_repo="runs/topdown_p1ger_500/seed_42",
            repo_id=repo_id,
            repo_type="dataset"
        )
