#!/usr/bin/env python3
"""Train and evaluate seed-42 plain P2 with TAL-positive confidence rescue."""
...
_SPEC = importlib.util.spec_from_file_location("_positive_confidence_rescue_workflow", ROOT / "train_all_levir_yolov8n_p2_routing.py")
workflow = importlib.util.module_from_spec(_SPEC)
sys.modules[_SPEC.name] = workflow
_SPEC.loader.exec_module(workflow)
workflow.EXPERIMENT = "levir_yolov8n_p2_positive_confidence_rescue"
workflow.HF_REPO = "duyle2408/levir-yolov8n-p2-positive-confidence-rescue-seed42"
workflow.VARIANTS = {
    "positive_confidence_rescue": ROOT.parent
